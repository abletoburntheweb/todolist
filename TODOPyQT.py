...
class MainWin(QMainWindow):
    ...
    def main_screen(self):
        ...
        self.btnTs1.setStyleSheet("QPushButton { border-radius: 15px; background-color: white; color: #BBBBBB; font-size: 20px}")
        self.btnTs1.show()

        self.btnTs1 = QtWidgets.QPushButton('Помыть посуду', self)
        self.btnTs1.setGeometry(25, 150, 450, 40)
        self.btnTs1.setStyleSheet("QPushButton { border-radius: 15px; background-color: white; color: #202020; font-size: 20px}")
        self.btnTs1.show()

        self.btnTs2 = QtWidgets.QPushButton('Сверстать этот TODO list', self)
        self.btnTs2.setGeometry(25, 200, 450, 40)
        self.btnTs2.setStyleSheet("QPushButton { border-radius: 15px; background-color: white; color: #202020; font-size: 20px}")
        self.btnTs2.show()

        self.btnTs3 = QtWidgets.QPushButton('Начать делать задачу', self)
        self.btnTs3.setGeometry(25, 250, 450, 40)
        self.btnTs3.setStyleSheet("QPushButton { border-radius: 15px; background-color: white; color: #202020; font-size: 20px}")
        ...
        self.btnTs4.setStyleSheet(
            "QPushButton { border-radius: 15px; background-color: white; color: #BBBBBB; font-size: 20px}")
        ...
        self.btnTs5.setStyleSheet(
            "QPushButton { border-radius: 15px; background-color: white; color: #202020; font-size: 20px}")
